...
def generate_test_paper(exam1, exam2, student_size = 60, part2_size = 2):
    '''
    1. Load the header file that is common on all test papers
    2. For each student,
        2.a. Choose a random question variation for Part 1
        2.b. Choose 2 random question variations for Part 2
        2.c. Determine the filename identifier for each question variations
        2.d. Add the questions to the test paper
...
def save_questions(questions, seperator = "\n=========\n"):
    ...
    print("{} questions saved.\n{} total variations created.".format(question_size, question_variations))
